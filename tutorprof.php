...
<body class="main-container">
    ...
    <tr><td><img class="info" src="info.png" title="The number of tutoring hours this tutor has completed." width="20" height="20"></img> Score: </td><td><?php echo $row["score"]; ?></td></tr>
